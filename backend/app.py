...
ALLOWED_ORIGINS = [
    ...
    "https://yourapp-git-main-yourusername.vercel.app",  # Preview deployments
...
- Never provide specific medical diagnoses or treatment recommendations"""
            ...
            try:
                ...
                async def get_response():
                    async for chunk in lab_agent.run(full_prompt, stream=True):
                        return chunk.content
                
                response = asyncio.run(get_response()) or "I apologize, but I couldn't generate a response. Please try rephrasing your question."
...
- Include disclaimer about not replacing professional medical advice"""
            ...
            try:
                response = ""
                async def get_response():
                    async for chunk in symptoms_agent.run(full_prompt, stream=True):
                        return chunk.content
                
                response = asyncio.run(get_response()) or "I apologize, but I couldn't generate a response. Please try describing your symptoms differently."
            ...
            return jsonify({
                ...
                "recommended_doctors": recommended_doctors[:1]  # Return top doctor
            })
...
- Use bullet points and clear formatting for better readability"""
            ...
            try:
                response = ""
                async def get_response():
                    async for chunk in general_agent.run(full_prompt, stream=True):
                        return chunk.content
